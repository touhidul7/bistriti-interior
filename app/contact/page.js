            ...
            <div className="lg:w-1/2 md:w-1/2 bg-gray-900 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0 p-10 rounded-lg">
              ...
              <div className="relative mb-4">
                ...
                <textarea
                  id="message"
                  name="message"
                  className="w-full bg-gray-900 rounded border border-gray-800 focus:border-none focus:ring-2 focus:ring-red-500 h-32 text-base outline-none text-2ray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"
                ></textarea>
              </div>
